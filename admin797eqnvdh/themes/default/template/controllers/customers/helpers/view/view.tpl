...
<div id="container-customer">
	<div class="row">
		...
		<div class="col-lg-6">
			<div class="panel clearfix">
				...
				<div class="form-horizontal">
                    ...
                    <div class="row">
                        <label class="control-label col-lg-3">{l s='Phone Number'}</label>
                        <div class="col-lg-9">
		...
		<div class="col-lg-6">
            ...
            <div class="panel">
                <div class="panel-heading">
                    <i class="icon-envelope"></i> {l s='Send the customer a message'}
                </div>
                <div class="alert alert-info">{l s='This message will be sent to the customer.'}</div>
                <form id="customer_note" class="form-horizontal" action="ajax.php" method="post" onsubmit="sendCustomerMessage({$customer->id|intval});return false;" >
                    <div class="form-group">
                        <div class="col-lg-12">
                            <textarea name="message" id="messageContent" onkeyup="$('#submitCustomerMessage').removeAttr('disabled');">{$customer_note}</textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">

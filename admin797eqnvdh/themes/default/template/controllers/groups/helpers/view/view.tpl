	...
	<div class="col-lg-6">
        ...
        <div class="panel">
            <div class="panel-heading">
                <i class="icon-envelope"></i> {l s='Send the group a message'}
            </div>
            <div class="alert alert-info">{l s='This message will be sent to the customers in this group.'}</div>
            <form id="customer_note" class="form-horizontal" action="ajax.php" method="post" onsubmit="sendGroupMessage({$group->id|intval});return false;" >
                <div class="form-group">
                    <div class="col-lg-12">

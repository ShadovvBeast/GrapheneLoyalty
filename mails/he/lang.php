...
$_LANGMAIL['Your guest account has been transformed into a customer account'] = 'חשבון האורח שלך שודרג לחשבון לקוח';
$_LANGMAIL['The virtual product that you bought is available for download'] = 'המוצר הוירטואלי שרכשת זמין להורדה';
$_LANGMAIL['New voucher for your order %s'] = 'שובר חדש עבור הזמנה %s';
$_LANGMAIL['Order confirmation'] = 'אישור הזמנה';
...
$_LANGMAIL['New credit slip regarding your order'] = 'שובר זיכוי חדש בהקשר להזמנתך';
$_LANGMAIL['New voucher for your order #%s'] = 'שובר חדש עבור הזמנה %s#';
$_LANGMAIL['Process the payment of your order'] = 'אנא השלם את התשלום עבור ההזמנה';
$_LANGMAIL['Your order return status has changed'] = '\'מצב טיפול\' בבקשת ההחזרה שלך עודכן';
...
$_LANGMAIL['Newsletter voucher'] = 'שובר ידיעון';
$_LANGMAIL['Newsletter confirmation'] = 'אישור רישום לידיעון';
$_LANGMAIL['Email verification'] = 'אימות מייל';
$_LANGMAIL['Your wishlist\'s link'] = 'קישור לרשימת המשאלות שלך';
...
$_LANGMAIL['We miss you'] = 'אנחנו מתגעגעים אליך';
$_LANGMAIL['Product available'] = 'המוצר זמין';
$_LANGMAIL['New order : #%d - %s'] = 'הזמנה חדשה מספר: %d - %s';
